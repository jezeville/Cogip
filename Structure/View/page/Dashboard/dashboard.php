...
<body>
    ...
    <div class="flex"> <!-- conteneur de la colonne et la page -->
        <div class="relative w-[15%] flex flex-col"><!-- conteneur de la colonne latérale -->
            <div class="mt-14">
                <img class="mx-auto rounded-full mb-[10%]" src="View/src/img/avatar_dashboard.svg" alt="Profile image">
                <p class="text-center font-bold text-2xl">Henry<br> George</p>
            </div>
            <div class=""> <!-- div visuelle de séparation -->
                <img src="View/src/img/Separation.png" class="mt-[15%] -ml-1 mb-[5%] pointer-events-none select-none">
            </div>
            <div class="flex flex-col mt-[15%] ml-[15%]"> <!-- conteneur du menu -->
                <div class="mb-[10%] flex flex-row"> <!-- conteneur de l'icone et du lien de menu -->
                    <img class="mr-[10%]" src="View/src/img/Icon_dashboard.png">
                    <a href="/Cogip/Structure/dashboard">Dashboard</a>
                </div>
                <div class="mb-[10%] flex flex-row"> <!-- conteneur de l'icone et du lien de menu -->
                    <img class="mr-[10%]" src="View/src/img/Icon_Invoices.png">
                    <a href="/Cogip/Structure/dashboard_invoice">Invoices</a>
                </div>
                <div class="mb-[10%] flex flex-row"> <!-- conteneur de l'icone et du lien de menu -->
                    <img class="mr-[10%]" src="View/src/img/Icon_companies.png">
                    <a href="/Cogip/Structure/dashboard_companie">Companies</a>
                </div>
                <div class="mb-[10%] flex flex-row"> <!-- conteneur de l'icone et du lien de menu -->
                    <img class="mr-[10%]" src="View/src/img/Icon_contact.png"> <a href="/Cogip/Structure/dashboard_contact">Contact</a>
                </div>
            </div>
            <div class="w-full absolute bottom-0 left-0 mb-2"> <!-- conteneur du log out -->
                <img class="" src="View/src/img/separation.png">
                <div class="mt-2 flex ml-4 mr-4 justify-center items-center">
                    <img src="View/src/img/avatar_dashboard.svg" class="w-10 w-1/6">
        ...
        <div class="bg-[#F5F5FB] w-[85%]"> <!-- conteneur de la page -->
            <div class="m-[4%] relative"> <!-- conteneur header -->
                ...
                <div class="bg-[#9698D6] rounded-lg text-white flex"> <!-- conteneur de la box "welcome back" -->
                    ...
                    <img class="absolute -top-14 right-32 h-full pointer-events-none select-none min-[320px]:hidden lg:block"
                        src="View/src/img/illustration_dashboard.svg">
                </div>
            </div>
            <!-- factures -->
            <div class="grid grid-cols-2 m-[4%] gap-10"> <!-- div conteneur des différentes box -->
                ...
                <div class="bg-white rounded-lg p-[5%] shadow-md">
                    ...
                    <img class="mt-2 mb-4 pointer-events-none select-none" src="View/src/img/separator.svg">
